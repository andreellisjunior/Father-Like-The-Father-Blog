...
const about = () => {
  return (
    <>
      {/* Hero Section */}
      <div className="hero-section about relative flex h-1/2-screen items-center justify-center font-primary text-white">
        <h1 className="z-50 text-7xl font-semibold">ABOUT</h1>
      </div>
